...
const CountdownTimer = ({ dropDate }) => {
   ...
   useEffect(() => {
    ...
    const interval = setInterval(() => {
        ...
        // Here it's as easy as doing some time match to get props
        ...
        // If our distance passes zero this means it's drop time!
        if (distance < 0) {
    ...
    return (
        <div className="timer-container">
            <p className="timer-header">Candy Drop Starting</p>
